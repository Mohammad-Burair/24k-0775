...
* Desc : Program that add cars to the dealership and display to available cars. The structure is used to define the car. Also the memory is dynamically allocated
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
